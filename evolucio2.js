...
function conte(){
console.log("Ja ha arribat la tardor! Les fulles cauen dels arbres,\nsurten els bolets i les castanyes.Com cada any la Castanyera es desperta de bon matí per anar a la muntanya a collir castanyes.Primer es posa la camisa que li va petita,després la faldilla que li fa campana, finalment les sabates que fan cloc-cloc i surt de casa contenta.Quan arriba el bosc veu els arbres carregats de castanyes, però a terra no n’hi ha ni una. Intenta sacsejar els arbres perquè caiguin,però no ho aconsegueix. Després crida el seu amic, el Gegant del Castanyer, que és molt alt i forçut.");
}
